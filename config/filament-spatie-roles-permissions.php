...
return [
    ...
    'super_admin_role_name' => env('SUPER_ADMIN_NAME', 'Super Admin'),
    ...
    'generator' => [
        ...
        'permission_affixes' => [
             ...
             */
            'viewAnyPermission' => 'Ver Todos',
            'viewPermission' => 'Ver Uno',
            'createPermission' => 'Crear',
            'updatePermission' => 'Actualizar',
            'deletePermission' => 'Eliminar',
            'deleteAnyPermission' => 'Eliminar Todos',
            'replicatePermission' => 'Replicar',
            'restorePermission' => 'Restaurar',
            'restoreAnyPermission' => 'Restaurar Todos',
            'reorderPermission' => 'Reordenar',
            'forceDeletePermission' => 'Forzar Eliminar',
            'forceDeleteAnyPermission' => 'Forzar Eliminar Todos',
        ],
