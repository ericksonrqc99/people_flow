    ...
    return (
        <div className="flex flex-col justify-center items-center h-full gap-4 sm:gap-6">
            <div className="w-full max-w-sm px-4">
                ...
                {/* Main Card */}
                <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border-t-4 border-t-blue-600">
                    <h1 className="text-center font-bold text-2xl sm:text-3xl md:text-4xl text-gray-800 mb-4 sm:mb-6">
                        Generar Ticket
                    </h1>
                    ...
                    <div className="mb-4 sm:mb-6">
                        ...
                        <input
                            ...
                            className="w-full text-center text-lg sm:text-2xl px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-300 rounded-lg focus:border-blue-600 focus:outline-none transition-colors"
                        />
                    </div>
                        ...
                        {isLoading ? (
                            <div className="flex flex-col items-center gap-2">
                                <div className="animate-spin">
                                    <div className="h-6 sm:h-8 w-6 sm:w-8 border-4 border-blue-600 border-t-transparent rounded-full"></div>
                                </div>
                                <span className="text-sm sm:text-base text-gray-600">Buscando DNI...</span>
                            </div>
                        ) : data.citizen.ok ? (
                            <div className="text-center p-3 sm:p-4 bg-green-50 border border-green-200 rounded-lg w-full">
                                <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2">Ciudadano encontrado:</p>
                            ...
                            error && (
                                <div className="text-center p-3 sm:p-4 bg-red-50 border border-red-200 rounded-lg w-full">
